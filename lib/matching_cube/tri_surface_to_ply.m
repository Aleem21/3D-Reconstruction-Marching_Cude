...
ply_data.vertex.red = round( node_xyz(4,1:node_num));
ply_data.vertex.green = round(node_xyz(5,1:node_num));
ply_data.vertex.blue = round(node_xyz(6,1:node_num));
ply_data.vertex.alpha = node_xyz(7,1:node_num);
%
